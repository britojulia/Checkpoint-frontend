  ...
  return (
    <nav className="flex justify-center">
      <ul className="flex space-x-8">
        ...
        <li><Link href="/temas/tema1" className="text-white hover:text-gray-400">D</Link></li>
        ...
        <li><Link href="/temas/tema4" className="text-white hover:text-gray-400">Teoria de Catástrofes Cósmicas</Link></li>
      </ul>
    </nav>
  );
}
